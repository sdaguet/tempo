odoo.define('darb_puthod.calendar', function (require) {
"use strict";
    ...
    initialize_m2o: function() {
        ...
        this.ir_model_m2o = new FieldMany2One(self.dfm, {
            attrs: {
               ...
               /* a ce niveau on ajoute un domaine sur responsable, l'idéale c'est
                d'avoir un boolean , on peut le definir facilement et le relier à l'état du user ou du de l'employee au niveau du code python
                j'ai testé plusieurs types de domaines, variable, objet... ici la condition doit être statique!!
                */
//                domain: "[('responsable','=',True)]",
    ...
    /* test sur l'objet hr.employee, on peut dupliquer le code du partner_id, pour garder les champs initials
